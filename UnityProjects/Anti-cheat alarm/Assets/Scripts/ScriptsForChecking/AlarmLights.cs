    ...
    private void Update()
    {
        ...
        foreach (Light light in _lights)
            light.color = new Color(
                r: Mathf.MoveTowards(light.color.r, _targetLightColor.r, runningTime/ _runTime), 
                g: Mathf.MoveTowards(light.color.g, _targetLightColor.g, runningTime / _runTime), 
                b: Mathf.MoveTowards(light.color.b, _targetLightColor.b, runningTime / _runTime));
